...
public class CMSSignedDataStreamEditor
{
        ...
        throws IOException, CMSException
    {
        ...
        // NOTE: jdk1.3 overlay. java.util.LinkedHashMap is a Java 1.4 API absent on JDK 1.3.
        Map<AlgorithmIdentifier, DigestCalculator> digests = new HashMap<AlgorithmIdentifier, DigestCalculator>();
        try
        {
