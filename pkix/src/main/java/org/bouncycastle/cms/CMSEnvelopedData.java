    ...
    implements Encodable
{
    ...
    public CMSEnvelopedData(
        ContentInfo contentInfo)
        throws CMSException {
        this(contentInfo, EnvelopedData.getInstance(contentInfo.getContent()));

    }

    protected CMSEnvelopedData(ContentInfo contentInfo, EnvelopedData envData) throws CMSException
    {
