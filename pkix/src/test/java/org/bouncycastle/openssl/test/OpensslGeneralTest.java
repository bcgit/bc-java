...
public class OpensslGeneralTest
    extends GeneralTest
{
    public static void main(String[] args)
        throws Exception
    {
        OpensslGeneralTest test = new OpensslGeneralTest();
        test.setUp();
        test.testPKCS8Encrypted();
        test.testParser();
    }
        ...
        throws Exception
    {
        ...
        trusted = new X509TrustedCertificateBlock(trusted.getCertificateHolder(), trusted.getTrustBlock());
        ...
        EdDSAPrivateKey edPrivKey = (EdDSAPrivateKey)new JcaPEMKeyConverter().setProvider(new BouncyCastleProvider()).getPrivateKey(edPrivInfo);
    ...
    private void checkTrustedCert(X509TrustedCertificateBlock trusted)
    {
        ...
        trustBlock = new CertificateTrustBlock(trustBlock.getAlias(), trustBlock.getUses(), trustBlock.getProhibitions());
    ...
    private void doOpenSslTestFile(
        ...
        throws IOException
    {
        keyDecryptTest(fileName, expectedPrivKeyClass, new JcePEMDecryptorProviderBuilder().setProvider(new BouncyCastleProvider()).build("changeit".toCharArray()));
        ...
        throws Exception
    {
        ...
        assertEquals(pInfo.getEncryptionAlgorithm().getAlgorithm(), PKCSObjectIdentifiers.id_PBES2);
        InputDecryptorProvider pkcs8Prov = new JceOpenSSLPKCS8DecryptorProviderBuilder().setProvider(new BouncyCastleProvider()).build("test".toCharArray());
    ...
    private void doDudPasswordTest(String password, int index, String message)
    {
        ...
        try
        {
            PEMDecryptorProvider decProv = new JcePEMDecryptorProviderBuilder().setProvider(new BouncyCastleProvider()).build(password.toCharArray());
            ...
            while ((o = pemRd.readObject()) != null)
            {
                ...
                {
                    assertNotNull(((PEMEncryptedKeyPair)o).getDekAlgName());
        ...
        throws Exception
    {
        ...
        assertTrue(kp.getPublicKeyInfo() == null);
    }
        ...
        throws NoSuchProviderException, NoSuchAlgorithmException, IOException, OperatorCreationException, PKCSException
    {
        ...
        JceOpenSSLPKCS8EncryptorBuilder encryptorBuilder = new JceOpenSSLPKCS8EncryptorBuilder(algorithm)
            ...
            .setRandom(CryptoServicesRegistrar.getSecureRandom())
