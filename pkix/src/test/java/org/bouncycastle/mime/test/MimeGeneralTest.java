...
public class MimeGeneralTest
    extends GeneralTest
{
    public static void main(String[] args)
        throws Exception
    {
        MimeGeneralTest test = new MimeGeneralTest();
        test.setUp();
        test.testMixtureOfHeaders();
    }
        ...
        throws Exception
    {
        ...
        Headers headers1 = new Headers(headers.getContentType(), "base64");
        assertFalse(headers1.isEmpty());
        assertEquals("Content-Type", headers1.getNames().next());
        assertTrue(headers1.containsKey("Content-Type"));
        assertEquals("Content-Type", headers1.iterator().next());
    }
