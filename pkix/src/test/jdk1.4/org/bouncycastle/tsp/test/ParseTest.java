    ...
    extends TestCase
{
    ...
    public void testEmptyInputRejectedCleanly()
    {
        ...
        // NOTE: the base CSRAttributesResponse (est) empty-input check is dropped here - the
        // org.bouncycastle.est package is excluded from the jdk1.4 distribution (ant/jdk14.xml),
        // so this overlay keeps the rest of ParseTest's coverage without it.
