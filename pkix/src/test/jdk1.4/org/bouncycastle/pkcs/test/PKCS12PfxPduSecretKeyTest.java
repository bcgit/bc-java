    ...
    extends TestCase
{
    ...
    // NOTE (jdk1.4 overlay): the base version of this test also round-trips an AES SecretKey
    // through the JCE PKCS#12 KeyStore, but the jdk1.4 distribution's PKCS12KeyStoreSpi does
    // not support secret-key (secretBag) entries, so only the pkix high-level builder
