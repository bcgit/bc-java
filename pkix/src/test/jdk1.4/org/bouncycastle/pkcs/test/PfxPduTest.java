    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        // valid test vectors
        byte test_vectors[][] = new byte[][]{pkcs12WithPBMac1PBKdf2_a1, pkcs12WithPBMac1PBKdf2_a2, pkcs12WithPBMac1PBKdf2_a3};
        for (int i = 0; i != test_vectors.length; i++)
        {
            byte[] test_vector = test_vectors[i];
        ...
        test_vectors = new byte[][]{pkcs12WithPBMac1PBKdf2_a4, pkcs12WithPBMac1PBKdf2_a5};
        for (int i = 0; i != test_vectors.length; i++)
        {
            byte[] test_vector = test_vectors[i];
            PKCS12PfxPdu pfx = new PKCS12PfxPdu(test_vector);
