...
// NOTE: jdk1.3 overlay. The KMACwithSHAKE tests are dropped: KeyGenerator.getInstance("KMAC128"/
// "KMAC256") never returns on real JDK 1.3.1 (javax.crypto.JCEUtil.findImplementation spins,
// unrelated to whether BC registers the algorithm - other KeyGenerator/Mac lookups in this same
// class complete normally), so no jdk1.3 fix is available; everything else in this class is kept.
