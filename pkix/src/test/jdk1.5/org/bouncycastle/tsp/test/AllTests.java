    ...
    extends TestCase
{
    ...
    public static Test suite()
    {
        ...
        // ERSTest is omitted here: it uses java.nio.file.Files (JDK 1.7+), absent from the
        // JRE 5 runtime this distribution targets. ERSTestdatenTest is retained (it is 1.5-clean).
