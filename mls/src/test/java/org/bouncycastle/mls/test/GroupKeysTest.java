...
import org.bouncycastle.mls.GroupKeys;
    ...
    extends TestCase
{
    ...
    public void testRatchets() throws Exception {
        ...
        GroupKeys keys = new GroupKeys(suite, treeSize, encryptionSecret);
    ...
    {
        return new TestSuite(GroupKeysTest.class);
    }
