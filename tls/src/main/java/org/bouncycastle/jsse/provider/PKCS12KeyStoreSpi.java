    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
        ...
        NoSuchAlgorithmException, CertificateException
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        // Check form PBMAC1 parameters
        ///////////////////////////////////////////////////////////////////////
        if (bcParam.getMacAlgorithm().getAlgorithm().equals(PKCSObjectIdentifiers.id_PBMAC1))
        {
        ...
        throws IOException
    {
        ...
        else
        {
            try
            {
                ...
                // for PBMAC1 we have a dummy salt and dummy iteration count
                // which is ignored when reading the mac
                if (PKCSObjectIdentifiers.id_PBMAC1.equals(macAlgorithm.getAlgorithm()))
                {
                    mData = new MacData(dInfo, new byte[0], 1);
                }
                else
                {
        ...
        throws Exception
    {
        if (PKCSObjectIdentifiers.id_PBMAC1.equals(oid))
        {
            ...
            {
                throw new IOException(
                    "No support for KDF parameter of type " + pbmac1Params.getKeyDerivationFunc().getAlgorithm().toString());
            }
        }
