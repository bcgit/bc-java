    ...
    extends DefaultTlsClient
{
    ...
    public void notifyAlertRaised(short alertLevel, short alertDescription, String message, Throwable cause)
    {
        ...
        out.println("TLS hybrid client raised alert: " + AlertLevel.getText(alertLevel)
    ...
    {
        PrintStream out = (alertLevel == AlertLevel.fatal) ? System.err : System.out;
        out.println("TLS hybrid client received alert: " + AlertLevel.getText(alertLevel)
            + ", " + AlertDescription.getText(alertDescription));
    }
    ...
    public TlsAuthentication getAuthentication() throws IOException
    {
        return new TlsAuthentication()
        {
            public void notifyServerCertificate(TlsServerCertificate serverCertificate) throws IOException
            {
                ...
                System.out.println("TLS hybrid client received server certificate chain of length " + chain.length);
