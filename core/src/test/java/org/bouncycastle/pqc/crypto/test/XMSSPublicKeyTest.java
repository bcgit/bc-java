    ...
    extends TestCase
{
    ...
    public void testPublicKeyParsingSHA256()
    {
        ...
        XMSSPublicKeyParameters publicKey = new XMSSPublicKeyParameters(params);
        byte[] root = {
        ...
        XMSSPublicKeyParameters publicKey2 = new XMSSPublicKeyParameters(params);
        try
        {
    ...
    {
        XMSSParameters params = new XMSSParameters(10, new SHA256Digest(), new NullPRNG());
        XMSSPublicKeyParameters pk = new XMSSPublicKeyParameters(params);
