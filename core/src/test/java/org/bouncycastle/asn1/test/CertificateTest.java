    ...
    extends SimpleTest
{
    ...
    // server.crt
    //
    private static final byte[] cert1 = Base64.decode(
    ...
    // ca.crt
    //
    private static final byte[] cert2 = Base64.decode(
    ...
    // testx509.pem
    //
    private static final byte[] cert3 = Base64.decode(
    ...
    // v3-cert1.pem
    //
    private static final byte[] cert4 = Base64.decode(
    ...
    // v3-cert2.pem
    //
    private static final byte[] cert5 = Base64.decode(
    ...
    private static final byte[] cert6 = Base64.decode(
    ...
    private static final byte[] cert7 = Base64.decode(
    ...
    private static final byte[] cert8 = Base64.decode(
    ...
    // malformed cert
    private static final byte[] bangerCert = Base64.decode(
    ...
    {
        Certificate obj = Certificate.getInstance(cert);
    ...
    public void checkAttributeCertificate(int id, byte[] cert) throws Exception
    {
        AttributeCertificate obj = AttributeCertificate.getInstance(cert);
        AttributeCertificateInfo acInfo = obj.getAcinfo();

        // Version
        ASN1Integer version = acInfo.getVersion();
    ...
    public void checkV1AttributeCertificate(int id, byte[] cert) throws Exception
    {
        AttributeCertificate obj = AttributeCertificate.getInstance(cert);
        AttributeCertificateInfo acInfo = obj.getAcinfo();

        // Version
        if (!acInfo.getVersion().hasValue(0))
        {
            fail("failed AC Version test for id " + id);
        }
