...
import org.bouncycastle.crypto.split.Polynomial2Table;
import org.junit.Test;

public class Polynomial2TableTest
    extends TestCase
{
    ...
    public static final int[][] TV011D_TV1_P = {
        {Polynomial2Table.gfPow(0x01, 0x00), Polynomial2Table.gfPow(0x01, 0x01)},
        {Polynomial2Table.gfPow(0x02, 0x00), Polynomial2Table.gfPow(0x02, 0x01)}
    };
    ...
    public static final int[][] TV011D_TV1_1_2_R = {
        {Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x01)), Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x02))}
    };
    ...
    public static final int[][] TV011D_TV2_P = {
        {Polynomial2Table.gfPow(0x01, 0x00), Polynomial2Table.gfPow(0x01, 0x01)},
        {Polynomial2Table.gfPow(0x02, 0x00), Polynomial2Table.gfPow(0x02, 0x01)},
        {Polynomial2Table.gfPow(0x03, 0x00), Polynomial2Table.gfPow(0x03, 0x01)},
        {Polynomial2Table.gfPow(0x04, 0x00), Polynomial2Table.gfPow(0x04, 0x01)}
    };
    ...
    public static final int[][] TV011D_TV2_1_2_R = {
        {Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x02))}
    };

    public static final int[][] TV011D_TV2_1_4_R = {
        {Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x01, 0x04)), Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x04))}
    };

    public static final int[][] TV011D_TV2_3_4_R = {
        {Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x03, 0x04)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x03, 0x04))}
    };
    ...
    public static final int[][] TV011D_TV3_P = {
        {Polynomial2Table.gfPow(0x01, 0x00), Polynomial2Table.gfPow(0x01, 0x01), Polynomial2Table.gfPow(0x01, 0x02)},
        {Polynomial2Table.gfPow(0x02, 0x00), Polynomial2Table.gfPow(0x02, 0x01), Polynomial2Table.gfPow(0x02, 0x02)},
        {Polynomial2Table.gfPow(0x03, 0x00), Polynomial2Table.gfPow(0x03, 0x01), Polynomial2Table.gfPow(0x03, 0x02)},
        {Polynomial2Table.gfPow(0x04, 0x00), Polynomial2Table.gfPow(0x04, 0x01), Polynomial2Table.gfPow(0x04, 0x02)}
    };
    ...
    public static final int[][] TV011D_TV3_1_2_3_R = {
        {
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x01, 0x03))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x02, 0x03))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x03)), Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x03))})
        }
    };

    public static final int[][] TV011D_TV3_1_2_4_R = {
        {
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x01, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x02, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x04)), Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x04))})
        }
    };

    public static final int[][] TV011D_TV3_1_3_4_R = {
        {
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x01, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x01, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x03, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x04)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x03, 0x04))})
        }
    };
    ...
    public static final int[][] TV011D_TV4_P = {
        {Polynomial2Table.gfPow(0x01, 0x00), Polynomial2Table.gfPow(0x01, 0x01), Polynomial2Table.gfPow(0x01, 0x02), Polynomial2Table.gfPow(0x01, 0x03)},
        {Polynomial2Table.gfPow(0x02, 0x00), Polynomial2Table.gfPow(0x02, 0x01), Polynomial2Table.gfPow(0x02, 0x02), Polynomial2Table.gfPow(0x02, 0x03)},
        {Polynomial2Table.gfPow(0x03, 0x00), Polynomial2Table.gfPow(0x03, 0x01), Polynomial2Table.gfPow(0x03, 0x02), Polynomial2Table.gfPow(0x03, 0x03)},
        {Polynomial2Table.gfPow(0x04, 0x00), Polynomial2Table.gfPow(0x04, 0x01), Polynomial2Table.gfPow(0x04, 0x02), Polynomial2Table.gfPow(0x04, 0x03)}
    };
    ...
    public static final int[][] TV011D_TV4_1_2_3_4_R = {
        {
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x01, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x01, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x02)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x02, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x02, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x03)), Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x03, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x01, Polynomial2Table.gfAdd(0x01, 0x04)), Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x04)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x03, 0x04))})
        }
    };
    ...
    public static final int[][] TV011D_TV5_P = {
        ...
        {Polynomial2Table.gfPow(0x03, 0x00), Polynomial2Table.gfPow(0x03, 0x01)},
        {Polynomial2Table.gfPow(0x04, 0x00), Polynomial2Table.gfPow(0x04, 0x01)},
        {Polynomial2Table.gfPow(0x05, 0x00), Polynomial2Table.gfPow(0x05, 0x01)},
        {Polynomial2Table.gfPow(0x06, 0x00), Polynomial2Table.gfPow(0x06, 0x01)},
        {Polynomial2Table.gfPow(0x07, 0x00), Polynomial2Table.gfPow(0x07, 0x01)},
        {Polynomial2Table.gfPow(0x08, 0x00), Polynomial2Table.gfPow(0x08, 0x01)},
        {Polynomial2Table.gfPow(0x09, 0x00), Polynomial2Table.gfPow(0x09, 0x01)}
    };
    ...
    public static final int[][] TV011D_TV5_8_9_R = {
        {Polynomial2Table.gfDiv(0x09, Polynomial2Table.gfAdd(0x08, 0x09)), Polynomial2Table.gfDiv(0x08, Polynomial2Table.gfAdd(0x08, 0x09))}
    };
    ...
    private static final int[][] TV011D_TV6_P = {
        ...
        {Polynomial2Table.gfPow(0x03, 0x00), Polynomial2Table.gfPow(0x03, 0x01), Polynomial2Table.gfPow(0x03, 0x02)},
        {Polynomial2Table.gfPow(0x04, 0x00), Polynomial2Table.gfPow(0x04, 0x01), Polynomial2Table.gfPow(0x04, 0x02)},
        {Polynomial2Table.gfPow(0x05, 0x00), Polynomial2Table.gfPow(0x05, 0x01), Polynomial2Table.gfPow(0x05, 0x02)}
    };
    ...
    private static final int[][] TV011D_TV6_2_3_4_R = {
        {
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x02, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x02, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x03)), Polynomial2Table.gfDiv(0x04, Polynomial2Table.gfAdd(0x03, 0x04))}),
            Polynomial2Table.gfProd(new int[]{Polynomial2Table.gfDiv(0x02, Polynomial2Table.gfAdd(0x02, 0x04)), Polynomial2Table.gfDiv(0x03, Polynomial2Table.gfAdd(0x03, 0x04))})
        }
    };
    ...
    {
        Polynomial2TableTest test = new Polynomial2TableTest();
        test.performTest();
    }
    ...
    {
        int[][] result = Polynomial2Table.gfMatMul(p, sr);
    ...
    {
        int[][] result = Polynomial2Table.gfMatMul(r, splits);
