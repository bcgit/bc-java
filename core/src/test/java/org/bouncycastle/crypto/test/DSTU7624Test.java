    ...
    extends CipherTest
{
    ...
    static SimpleTest[] tests =
        {
            ...
            new BlockCipherVectorTest(1, new DSTU7624Engine(128, 256), new KeyParameter(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F")), "202122232425262728292A2B2C2D2E2F", "58EC3E091000158A1148F7166F334F14"),
            new BlockCipherVectorTest(2, new DSTU7624Engine(256, 256), new KeyParameter(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F")), "202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F", "F66E3D570EC92135AEDAE323DCBD2A8CA03963EC206A0D5A88385C24617FD92C"),
            new BlockCipherVectorTest(3, new DSTU7624Engine(256, 512), new KeyParameter(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F")), "404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F", "606990E9E6B7B67A4BD6D893D72268B78E02C83C3CD7E102FD2E74A8FDFE5DD9"),
            new BlockCipherVectorTest(4, new DSTU7624Engine(512, 512), new KeyParameter(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F")), "404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F707172737475767778797A7B7C7D7E7F", "4A26E31B811C356AA61DD6CA0596231A67BA8354AA47F3A13E1DEEC320EB56B895D0F417175BAB662FD6F134BB15C86CCB906A26856EFEB7C5BC6472940DD9D9"),
        ...
        throws Exception
    {
        ...
        KCCMBlockCipher dstu7624ccm = new KCCMBlockCipher(new DSTU7624Engine(128, 128));
        ...
        dstu7624ccm = new KCCMBlockCipher(new DSTU7624Engine(256, 256));
        ...
        dstu7624ccm = new KCCMBlockCipher(new DSTU7624Engine(256, 512));
        ...
        dstu7624ccm = new KCCMBlockCipher(new DSTU7624Engine(512, 512));
        ...
        throws Exception
    {
        ...
        KXTSBlockCipher dstu7624xts = new KXTSBlockCipher(new DSTU7624Engine(128, 128));
        ...
        dstu7624xts = new KXTSBlockCipher(new DSTU7624Engine(128, 256));
        ...
        dstu7624xts = new KXTSBlockCipher(new DSTU7624Engine(256, 256));
        param = new ParametersWithIV(new KeyParameter(key), iv);
        ...
        dstu7624xts = new KXTSBlockCipher(new DSTU7624Engine(256, 512));
        param = new ParametersWithIV(new KeyParameter(key), iv);
        ...
        dstu7624xts = new KXTSBlockCipher(new DSTU7624Engine(512, 512));
        param = new ParametersWithIV(new KeyParameter(key), iv);
        ...
        throws Exception
    {
        ...
        KGCMBlockCipher dstu7624gcm = new KGCMBlockCipher(new DSTU7624Engine(128, 128));
