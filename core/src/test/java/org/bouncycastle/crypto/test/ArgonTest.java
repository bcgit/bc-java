    ...
    extends SimpleTest
{
    ...
    private void hashTest(int version, int iterations, int memory, int parallelism,
        ...
        throws Exception
    {
        Argon2.Argon2ParametersBuilder builder = Argon2.builder(Argon2.ArgonType.Argon2i)
            .withVersion(version)
        ...
        // Set the password.
        //
        builder.getPasswordOutputStream().write(builder.encodeString(password));

        Argon2 dig = new Argon2(builder.build());


        byte[] result = new byte[outputLength];
        dig.generate(result, 0);
        ...
        throws Exception
    {
        ...
        Argon2.Argon2ParametersBuilder builder = Argon2.builder(Argon2.ArgonType.Argon2d)
        ...
        builder.getPasswordOutputStream().write(password);
        Argon2 dig = new Argon2(builder.build());
        ...
        builder = Argon2.builder(Argon2.ArgonType.Argon2i)
            .withVersion(ARGON2_VERSION_13) // 19
            .withIterations(3)
            .withMemory(32)
            .withParallelism(4)
        ...
        builder = Argon2.builder(Argon2.ArgonType.Argon2id)
            .withVersion(ARGON2_VERSION_13) // 19
            .withIterations(3)
            .withMemory(32)
            .withParallelism(4)
