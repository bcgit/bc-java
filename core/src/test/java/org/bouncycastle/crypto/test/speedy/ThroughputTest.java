...
import org.bouncycastle.crypto.engines.ThreefishReferenceEngine;
...
//        speedTestCipher(new BlowfishEngine(), input);
    ...
    private static void speedTestCipher(BlockCipher cipher, byte[] input) throws InterruptedException
    {
    ...
    private static void speedTestCipherForMode(String mode, BlockCipher cipher, byte[] input) throws InterruptedException
    {
        System.out.println("======");
