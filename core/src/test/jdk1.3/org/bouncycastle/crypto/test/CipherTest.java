...
// NOTE: jdk1.3 overlay, regenerated from base (the previous overlay predated the AEAD test helper
// methods added for later NIST LWC finalist ports -- GIFT-COFB, Grain-128AEAD, Romulus, etc. --
// and was ~750 lines out of sync). The only genuine 1.3 adaptation needed is in checkCipher(int,
// int, int, int, Instance): RuntimeException(Throwable) is a Java 1.4 constructor absent on JDK
// 1.3. Everything else here is 1.3-clean (generics/@Override are stripped by the preprocessor).
...
//    }
    ...
    static void checkCipher(int aeadLen, int ivLen, int msgLen, int strength, Instance instance)
    {
        ...
        {
            // NOTE: jdk1.3 overlay. RuntimeException(Throwable) is a Java 1.4 constructor absent
            // on JDK 1.3.
