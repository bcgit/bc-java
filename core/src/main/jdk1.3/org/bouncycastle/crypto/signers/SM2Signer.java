 ...
 * <p>
 * NOTE (jdk1.3 overlay): base SM2Signer logs verification-failure diagnostics via
 * java.util.logging (Java 1.4, absent on JDK 1.3). This overlay is base with the
 * logging import/field and the guarded LOG.* diagnostic blocks removed; all signing
 * and verification behaviour (and every exception message) is identical to base.
 */
    ...
    implements Signer, ECConstants
{
    ...
    public boolean verifySignature(byte[] signature)
    {
        ...
        {
            // SM2 signature verification failed due to exception
        }
        finally
        {
            reset();
