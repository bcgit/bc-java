...
{
    // NOTE (jdk1.4 overlay): this file is the current base IETFUtils minus the two legacy
    // StringBuffer overloads of appendRDN / appendTypeAndValue. The 1.4 build rewrites
    // StringBuilder to StringBuffer during source preprocessing, so keeping both overload
    // families would collapse them into duplicate method definitions. Keep everything else
    // in step with the base copy.
