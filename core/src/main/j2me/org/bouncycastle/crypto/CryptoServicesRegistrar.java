...
public final class CryptoServicesRegistrar
{
    ...
    private static final Map threadProperties = new HashMap();
    private static final Hashtable globalProperties = new Hashtable();
    ...
    private static boolean preconfiguredConstraints;
    ...
    {
        Map properties = (Map)threadProperties.get(Thread.currentThread());
        Object[] values;
    ...
    public static void setThreadProperty(Property property, Object[] propertyValue)
    {
        ...
        localSetThread(property, (Object[])propertyValue);
    }
    ...
    {
        localSetGlobalProperty(property, (Object[])propertyValue);
    }
    ...
    private static void localSetThread(Property property, Object[] propertyValue)
    {
        ...
        if (properties == null)
        {
            ...
            threadProperties.put(Thread.currentThread(), properties);
        }
