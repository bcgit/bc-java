...
class GFCalculator
{
    ...
    {
        int tmp = Utils.toUnsigned16Bits(a - GF_MUL_ORDER);
        int mask = Utils.toUnsigned8bits(-(tmp >> 15));
        return Utils.toUnsigned16Bits(tmp + (mask & GF_MUL_ORDER));
    }

    static int inverse(int a)
    {
        int mask = Utils.toUnsigned16Bits(-a >> 31);
        return mask & exp[GF_MUL_ORDER - log[a]];
    }
}
