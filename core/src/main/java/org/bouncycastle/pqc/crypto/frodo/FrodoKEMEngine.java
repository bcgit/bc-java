...
//    private static void kem_keypair(byte[] pk, byte[] sk, SecureRandom random)
//    {
...
//    private static void kem_enc(byte[] ct, byte[] ss, byte[] pk, SecureRandom random)
//    {
//        // Parse pk = seedA || b
...
//    private static void kem_dec(byte[] ss, byte[] ct, byte[] sk)
//    {
//        // Parse ct = c1 || c2
//        int offset = 0;
...
//    }
    ...
    // TODO this is specific to shake (aes requires a different implementation)
    abstract short[][] genMatrix(byte[] seedA) throws IllegalBlockSizeException, BadPaddingException, IOException, InvalidKeyException;

    static class Shake128Engine
            extends FrodoKEMEngine
    {
        public Shake128Engine(int n)
        {
            super(n);
        }
    ...
    static class Aes128Engine
            extends FrodoKEMEngine
    {
        Cipher cipher;
        public Aes128Engine(int n) throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException
        {
            super(n);
