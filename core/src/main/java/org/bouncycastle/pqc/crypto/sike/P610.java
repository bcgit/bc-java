...
//            COMPRESSED_TABLES = #define ELL2_FULL_SIGNED    // Uses signed digits to reduce table size by half;
//            ELL3_FULL_SIGNED = // Uses signed digits to reduce table size by half;
