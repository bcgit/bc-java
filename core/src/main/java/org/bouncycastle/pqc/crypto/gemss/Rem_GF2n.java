...
class Rem_GF2n
{
                                        ...
                                        int k264, int k364, long[] Q, long mask)
    {
        ...
        Q[7] = (Pol[15] >>> ki) ^ (Pol[16] << ki64);
        Q[8] = Pol[16] >>> ki;
        P[p_cp] = Pol[0] ^ Q[0] ^ (Q[0] << k1) ^ (Q[0] << k2) ^ (Q[0] << k3);
        P[p_cp + 1] = Pol[1] ^ Q[1] ^ (Q[0] >>> k164) ^ (Q[1] << k1) ^ (Q[0] >>> k264) ^ (Q[1] << k2) ^ (Q[0] >>> k364) ^ (Q[1] << k3);
        P[p_cp + 2] = Pol[2] ^ Q[2] ^ (Q[1] >>> k164) ^ (Q[2] << k1) ^ (Q[1] >>> k264) ^ (Q[2] << k2) ^ (Q[1] >>> k364) ^ (Q[2] << k3);
        P[p_cp + 3] = Pol[3] ^ Q[3] ^ (Q[2] >>> k164) ^ (Q[3] << k1) ^ (Q[2] >>> k264) ^ (Q[3] << k2) ^ (Q[2] >>> k364) ^ (Q[3] << k3);
        P[p_cp + 4] = Pol[4] ^ Q[4] ^ (Q[3] >>> k164) ^ (Q[4] << k1) ^ (Q[3] >>> k264) ^ (Q[4] << k2) ^ (Q[3] >>> k364) ^ (Q[4] << k3);
        P[p_cp + 5] = Pol[5] ^ Q[5] ^ (Q[4] >>> k164) ^ (Q[5] << k1) ^ (Q[4] >>> k264) ^ (Q[5] << k2) ^ (Q[4] >>> k364) ^ (Q[5] << k3);
        P[p_cp + 6] = Pol[6] ^ Q[6] ^ (Q[5] >>> k164) ^ (Q[6] << k1) ^ (Q[5] >>> k264) ^ (Q[6] << k2) ^ (Q[5] >>> k364) ^ (Q[6] << k3);
        P[p_cp + 7] = Pol[7] ^ Q[7] ^ (Q[6] >>> k164) ^ (Q[7] << k1) ^ (Q[6] >>> k264) ^ (Q[7] << k2) ^ (Q[6] >>> k364) ^ (Q[7] << k3);
        P[p_cp + 8] = (Pol[8] ^ Q[8] ^ (Q[7] >>> k164) ^ (Q[8] << k1) ^ (Q[7] >>> k264) ^ (Q[8] << k2) ^ (Q[7] >>> k364) ^ (Q[8] << k3)) & mask;
//        P[p_cp] ^= Q[0] << k1;
...
//        Q[2] = (Pol[8] >>> ki) ^ (Pol[9] << ki64);
        ...
        Q[6] = (Pol[12] >>> ki);
        Q[0] = (Q[3] >>> 39) ^ (Q[4] << 25) ^ (Pol[6] >>> ki) ^ (Pol[7] << ki64);
        Q[1] = (Q[4] >>> 39) ^ (Q[5] << 25) ^ (Pol[7] >>> ki) ^ (Pol[8] << ki64);
        Q[2] = (Q[5] >>> 39) ^ (Q[6] << 25) ^ (Pol[8] >>> ki) ^ (Pol[9] << ki64);
        P[p_cp] = Pol[0] ^ Q[0];
        P[p_cp + 1] = Pol[1] ^ Q[1];
        P[p_cp + 2] = Pol[2] ^ Q[2] ^ (Q[0] << k3);
        P[p_cp + 3] = Pol[3] ^ Q[3] ^ (Q[0] >>> k364) ^ (Q[1] << k3);
        P[p_cp + 4] = Pol[4] ^ Q[4] ^ (Q[1] >>> k364) ^ (Q[2] << k3);
        P[p_cp + 5] = Pol[5] ^ Q[5] ^ (Q[2] >>> k364) ^ (Q[3] << k3);
        P[p_cp + 6] = (Pol[6] ^ Q[6] ^ (Q[3] >>> k364)) & mask;
...
//    static void REM192_SPECIALIZED_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
...
//    }
//
//    static void REM288_SPECIALIZED_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
...
//    }
//
//    static void REM384_SPECIALIZED_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
...
//    }
//
//    static void REM384_SPECIALIZED358_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
...
//    }
//
//    static void REM384_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
...
//    }
//
//    static void REM402_SPECIALIZED_TRINOMIAL_GF2X(long[] P, int p_cp, long[] Pol, int k3, int ki, int ki64, int k364, long mask)
//    {
