...
//                new CrossPublicKeyParameters(params, seedPk, packedS),
//                new CrossPrivateKeyParameters(params, seedSk, e_bar)
//            );
//        }
...
//            engine.fzDzNormN(e_bar);
//
//            // Step 6: Compute syndrome
//            short[] s = new short[params.getN() - params.getK()];
//            engine.restrVecByFpMatrix(s, e_bar, V_tr, params);
//            // For P=509, normalization is identity so we skip explicit call
//            byte[] packedS = new byte[params.getDenselyPackedFpSynSize()];
//            Pack.shortToLittleEndian(s, );
//            engine.packFpSyn(packedS, , params);
//
//            return new AsymmetricCipherKeyPair(
//                new CrossPublicKeyParameters(params, seedPk, packedS),
//                new CrossPrivateKeyParameters(params, seedSk, e_bar)
...
//        else
//        {
//            throw new IllegalStateException("Unsupported prime field size");
//        }
        return null;
    }
