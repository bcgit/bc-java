...
class RainbowPublicMap
{
    ...
    public short[] publicMap_cyclic(RainbowCyclicPublicKeyParameters pk, short[] signature)
    {
        ...
        accu_l1 = cf.addMatrix(accu_l1, compute_accumulator(sig_o2, sig_v1, pk.getL1_Q3(), o1));
        accu_l1 = cf.addMatrix(accu_l1, compute_accumulator(sig_o1, sig_o1, pk.getL1_Q5(), o1));
        accu_l1 = cf.addMatrix(accu_l1, compute_accumulator(sig_o2, sig_o1, pk.getL1_Q6(), o1));
        accu_l1 = cf.addMatrix(accu_l1, compute_accumulator(sig_o2, sig_o2, pk.getL1_Q9(), o1));
        ...
        accu_l2 = cf.addMatrix(accu_l2, compute_accumulator(sig_o2, sig_o2, pk.getL2_Q9(), o2));
