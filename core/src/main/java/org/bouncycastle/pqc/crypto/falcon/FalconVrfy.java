...
//    #define R2    10952
    ...
    void mq_iNTT(short[] srca, int a, int logn)
    {
        ...
        for (m = 0; m < n; m++)
        {
            srca[a + m] = (short)mq_montymul(srca[a + m], ni);
        }
    }
    ...
    void mq_poly_tomonty(short[] srcf, int f, int logn)
    {
        ...
        for (u = 0; u < n; u++)
        {
            srcf[f + u] = (short)mq_montymul(srcf[f + u], R2);
        }
    }
    ...
    void mq_poly_montymul_ntt(short[] srcf, int f, short[] srcg, int g, int logn)
    {
        ...
        for (u = 0; u < n; u++)
        {
            srcf[f + u] = (short)mq_montymul(srcf[f + u], srcg[g + u]);
        }
    }
                       ...
                       byte[] srcf, int f, byte[] srcg, int g, int logn, short[] srctmp, int tmp)
    {
        ...
        for (u = 0; u < n; u++)
        {
            ...
            srch[h + u] = (short)mq_div_12289(srch[h + u], srctmp[tt + u]);
        }
        mq_iNTT(srch, h, logn);
        return 1;
    }
                         ...
                         int logn, short[] srctmp, int tmp)
    {
        ...
        mq_poly_tomonty(srctmp, t1, logn);
