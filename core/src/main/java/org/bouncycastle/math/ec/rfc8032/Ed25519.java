...
//        x14 += (x13 >> 28); x13 &= M28L;
        ...
        x01 += (x00 >> 28); x00 &= M28L;            // x01:55/28, x00:28/--
        x02 += (x01 >> 28); x01 &= M28L;            // x02:56/--, x01:28/--
        x03 += (x02 >> 28); x02 &= M28L;            // x03:57/--, x02:28/--
        x04 += (x03 >> 28); x03 &= M28L;            // x04:57/29, x03:28/--
        x05 += (x04 >> 28); x04 &= M28L;            // x05:56/54, x04:28/--
        x06 += (x05 >> 28); x05 &= M28L;            // x06:56/54, x05:28/--
        x07 += (x06 >> 28); x06 &= M28L;            // x07:56/54, x06:28/--
