...
{
    SecT193R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y)
    {
        super(curve, x, y);
    }

    SecT193R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs)
    {
        super(curve, x, y, zs);
    }
    ...
    public ECPoint add(ECPoint b)
    {
        ...
        if (X2.isZero())
        {
            ...
            if (X3.isZero())
            {
                return new SecT193R1Point(curve, X3, curve.getB().sqrt());
            }
    ...
    public ECPoint twice()
    {
        ...
        if (T.isZero())
        {
            return new SecT193R1Point(curve, T, curve.getB().sqrt());
        }
    ...
    public ECPoint twicePlus(ECPoint b)
    {
        ...
        if (A.isZero())
        {
            return new SecT193R1Point(curve, A, curve.getB().sqrt());
        }
