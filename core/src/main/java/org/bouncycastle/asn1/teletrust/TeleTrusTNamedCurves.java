...
public class TeleTrusTNamedCurves
{
    ...
    static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "04BED5AF16EA3F6A4F62938C4631EB5AF7BDBCDBC31667CB477A1A8EC338F94741669C976316DA6321"), // G
                n, h, null);
        }
    };
    ...
    static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "04B199B13B9B34EFC1397E64BAEB05ACC265FF2378ADD6718B7C7C1961F0991B842443772152C9E0AD"), // G
                n, h, null);
        }
    };
    ...
    static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "04C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD614B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F"), // G
                n, h, null);
        }
    };
    ...
    static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "043AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9"), // G'
                n, h, null);
        }
    };
    ...
    static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "040D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD"), // G
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP224t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "046AB1E344CE25FF3896424E7FFE14762ECB49F8928AC0C76029B4D5800374E9F5143E568CD23F3F4D7C0D4B1E41C8CC0D1C6ABD5F1A46DB4C"), // G'
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997"), // G
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP256t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "04A3E8EB3CC1CFE7B7732213B23A656149AFA142C47AAFBC2B79A191562E1305F42D996C823439C56D7F7B22E14644417E69BCB6DE39D027001DABE8F35B25C9BE"), // G'
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "0443BD7E9AFB53D8B85289BCC48EE5BFE6F20137D10A087EB6E7871E2A10A599C710AF8D0D39E2061114FDD05545EC1CC8AB4093247F77275E0743FFED117182EAA9C77877AAAC6AC7D35245D1692E8EE1"), // G
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP320t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "04925BE9FB01AFC6FB4D3E7D4990010F813408AB106C4F09CB7EE07868CC136FFF3357F624A21BED5263BA3A7A27483EBF6671DBEF7ABB30EBEE084E58A0B077AD42A5A0989D1EE71B1B9BC0455FB0D2C3"), // G'
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "041D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E8ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315"), // G
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP384t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, "0418DE98B02DB9A306F2AFCD7235F72A819B80AB12EBD653172476FECD462AABFFC4FF191B946A5F54D8D0AA2F418808CC25AB056962D30651A114AFD2755AD336747F93475B7A1FCA3B88F2B6A208CCFE469408584DC2B2912675BF5B9E582928"), // G'
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP512r1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, ""), // G
                n, h, null);
        }
    };
    static X9ECParametersHolder brainpoolP512t1 = new X9ECParametersHolder()
    {
        protected X9ECParameters createParameters()
        {
            ...
            return new X9ECParameters(
                curve,
                decodePoint(curve, ""), // G'
                n, h, null);
        }
    };
