 ...
 * <b>8.21.10</b> For the UTF8String type, the octet string shall
 * contain the octets specified in ISO/IEC 10646-1, Annex D. 
 * Announcers and escape sequences shall not be used,
 * and each character shall be encoded in the smallest number of octets 
 * available for that character.
 * <hr>
 * <h2>X.690 (general string rules)</h2>
 * <h3>8: Basic encoding rules</h3>
 * <h4>8.21 Encoding for values of the restricted character string types </h4>
