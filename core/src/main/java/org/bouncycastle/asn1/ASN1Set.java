    ...
    implements org.bouncycastle.util.Iterable<ASN1Encodable>
{
    ...
    ASN1Set(Vector v, boolean isSorted)
    {
        this.set = v;
    ...
    private static void sort(Vector set)
    {
        if (set.size() < 2)
        {
            return;
