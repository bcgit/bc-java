...
/**
 * Generation of the public matrix A for the standardised FrodoKEM parameter sets
 * (ISO/IEC 18033-2:2006/Amd 2:2026, Clause 14). Two variants are defined: the SHAKE128 variant
 * (Clause 14.5.8.3, OIDs {@code id-kem-frodokem*-shake}) and the AES-128 variant
 * (OIDs {@code id-kem-frodokem*-aes}, {@code 1.0.18033.2.2.7.5}-{@code .8}).
 */
abstract class FrodoMatrixGenerator
{
    ...
    {
        Shake128MatrixGenerator(int n, int q)
        {
            super(n, q);
        }
    ...
    static class Aes128MatrixGenerator
        extends FrodoMatrixGenerator
    {
        Aes128MatrixGenerator(int n, int q)
        {
            super(n, q);
        }
