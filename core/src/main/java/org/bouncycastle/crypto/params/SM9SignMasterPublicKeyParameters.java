 ...
 */
public class SM9SignMasterPublicKeyParameters
    extends AsymmetricKeyParameter
{
    private final SM9G2Point pPub;

    SM9SignMasterPublicKeyParameters(SM9G2Point pPub)
    {
        super(false);
        this.pPub = pPub;
    }
    ...
    public static SM9SignMasterPublicKeyParameters fromEncoded(byte[] enc)
    {
        return new SM9SignMasterPublicKeyParameters(SM9G2Point.decode(enc));
    }
}
