...
import org.bouncycastle.smartcard.simulator.SimulatorOpenPGPSmartCard;
import org.bouncycastle.smartcard.simulator.SimulatorSmartCardBackend;
        ...
        extends AbstractOpenPGPSmartCardTest
{
    ...
    private void testFixedRSA2048Key() throws IOException, PGPException, CardException {
            ...
            throws CardException, PGPException, IOException
    {
        ...
        OpenPGPKey rsaKey = api.generateKey(4)
                ...
                .build();
        testEncryptDecryptWithExternalKey(rsaKey);
    }
            ...
            throws CardException, PGPException, IOException
    {
        ...
        OpenPGPKey ecdhKey = api.generateKey(4)
                ...
                .build();
        testEncryptDecryptWithExternalKey(ecdhKey);
    }
            ...
            throws PGPException, IOException, CardException
    {
        ...
        OpenPGPKey x25519Key = api.generateKey(4)
                ...
                .build();
        testEncryptDecryptWithExternalKey(x25519Key);
    }
    ...
    private void testEncryptDecryptWithExternalKey(OpenPGPKey softwareKey)
            throws PGPException, IOException, CardException
    {
