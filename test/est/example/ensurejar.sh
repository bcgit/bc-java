...
if  type curl > /dev/null; then
    curl -o bcprov.jar  https://downloads.bouncycastle.org/betas/bcprov-jdk15on-157b14.jar
    curl -o bctls.jar https://downloads.bouncycastle.org/betas/bctls-jdk15on-157b14.jar
    curl -o suffixlist.dat  https://www.publicsuffix.org/list/public_suffix_list.dat
elif type wget > /dev/null ; then
    wget -O bcprov.jar https://downloads.bouncycastle.org/betas/bcprov-jdk15on-157b14.jar
    wget -O bctls.jar https://downloads.bouncycastle.org/betas/bctls-jdk15on-157b14.jar
