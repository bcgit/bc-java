...
public class EtsiTs103097Data_Encrypted extends EtsiTs103097Data
{
    ...
    public static EtsiTs103097Data_Encrypted getInstance(Object o)
    {
        if (o instanceof EtsiTs103097Data_Encrypted)
        {
            return (EtsiTs103097Data_Encrypted)o;
        }
        if (o != null)
        {
            return new EtsiTs103097Data_Encrypted(ASN1Sequence.getInstance(o));
        }
        return null;
    }
}
