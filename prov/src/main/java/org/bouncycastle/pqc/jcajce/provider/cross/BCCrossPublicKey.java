...
public class BCCrossPublicKey
    implements PublicKey, CrossKey
{
    private static final long serialVersionUID = 1L;

    private transient CrossPublicKeyParameters params;

    public BCCrossPublicKey(
        CrossPublicKeyParameters params)
    {
        this.params = params;
    }

    public BCCrossPublicKey(SubjectPublicKeyInfo keyInfo)
        throws IOException
    {
        init(keyInfo);
    }
    ...
    private void init(SubjectPublicKeyInfo keyInfo)
        throws IOException
    {
        this.params = (CrossPublicKeyParameters) PublicKeyFactory.createKey(keyInfo);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (o instanceof BCCrossPublicKey)
        {
            BCCrossPublicKey otherKey = (BCCrossPublicKey)o;
    ...
    CrossPublicKeyParameters getKeyParams()
    {
        return params;
    }
