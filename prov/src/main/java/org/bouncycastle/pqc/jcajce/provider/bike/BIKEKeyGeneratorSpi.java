        ...
        extends KeyGeneratorSpi
{
    ...
    protected SecretKey engineGenerateKey()
    {
        if (genSpec != null)
        {
            BCBIKEPublicKey pubKey = (BCBIKEPublicKey)genSpec.getPublicKey();
        ...
        {
            BCBIKEPrivateKey privKey = (BCBIKEPrivateKey)extSpec.getPrivateKey();
            BIKEKEMExtractor kemExt = new BIKEKEMExtractor(privKey.getKeyParams());
