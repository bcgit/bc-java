...
public class NTRULPRimeKeyFactorySpi
    ...
    implements AsymmetricKeyInfoConverter
{
            ...
            throws InvalidKeySpecException
    {
        ...
        else if (key instanceof BCNTRULPRimePublicKey)
        {
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo keyInfo)
            throws IOException
    {
        return new BCNTRULPRimePrivateKey(keyInfo);
    }

    public PublicKey generatePublic(SubjectPublicKeyInfo keyInfo)
            throws IOException
    {
        return new BCNTRULPRimePublicKey(keyInfo);
    }
}
