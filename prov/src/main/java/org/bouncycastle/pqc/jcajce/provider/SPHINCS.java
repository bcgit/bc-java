...
public class SPHINCS
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            provider.addAlgorithm("AlgorithmParameters.SHA512WITHSPHINCS256", PREFIX + "AlgorithmParametersSpi");
            provider.addAlgorithm("AlgorithmParameters.SHA3-512WITHSPHINCS256", PREFIX + "AlgorithmParametersSpi");
