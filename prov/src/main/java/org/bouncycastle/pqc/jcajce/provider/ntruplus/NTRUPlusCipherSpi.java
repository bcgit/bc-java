...
class NTRUPlusCipherSpi
    extends CipherSpi
{
    private final String algorithmName;
    private NTRUPlusKEMGenerator kemGen;
    private KTSParameterSpec kemParameterSpec;
    private BCNTRUPlusPublicKey wrapKey;
    private BCNTRUPlusPrivateKey unwrapKey;
    private AlgorithmParameters engineParams;
    private NTRUPlusParameters ntruplusParameters;

    NTRUPlusCipherSpi(String algorithmName)
        throws NoSuchAlgorithmException
    {
        this.algorithmName = algorithmName;
    }

    NTRUPlusCipherSpi(NTRUPlusParameters ntruplusParameters)
    {
        this.ntruplusParameters = ntruplusParameters;
        this.algorithmName = Strings.toUpperCase(ntruplusParameters.getName());
    }
        ...
        throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        {
            if (key instanceof BCNTRUPlusPublicKey)
            {
                wrapKey = (BCNTRUPlusPublicKey)key;
                kemGen = new NTRUPlusKEMGenerator(CryptoServicesRegistrar.getSecureRandom(random));
            }
            else
            {
        ...
        else if (opmode == Cipher.UNWRAP_MODE)
        {
            ...
            {
                unwrapKey = (BCNTRUPlusPrivateKey)key;
            }
            else
            {
        ...
        throws InvalidKeyException, NoSuchAlgorithmException
    {
        ...
        try
        {
            NTRUPlusKEMExtractor kemExt = new NTRUPlusKEMExtractor(unwrapKey.getKeyParams());
