...
{
    private static String info = "BouncyCastle Security Provider v1.50b";
    ...
    {
        "AES", "ARC4", "Blowfish", "Camellia", "CAST5", "CAST6", "ChaCha", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA",
        "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Skipjack", "TEA", "Twofish", "VMPC", "VMPCKSA3", "XTEA", "XSalsa20"
    };
    ...
    {
        super(PROVIDER_NAME, 1.495, info);
