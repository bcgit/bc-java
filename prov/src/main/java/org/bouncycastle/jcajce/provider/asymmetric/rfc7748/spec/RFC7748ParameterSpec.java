 ...
 *
 */
public class RFC7748ParameterSpec implements AlgorithmParameterSpec, Serializable {
     ...
     */
    public RFC7748ParameterSpec(Curve curve, String hashAlgo,
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof RFC7748ParameterSpec))
            return false;
        RFC7748ParameterSpec s = (RFC7748ParameterSpec) o;
