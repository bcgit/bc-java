 ...
 *
 */
public class RFC7748PrivateKeySpec implements KeySpec {
     ...
     */
    public RFC7748PrivateKeySpec(byte[] seed, RFC7748ParameterSpec spec) {
     ...
     *  @since 0.1.1
     */
    public RFC7748PrivateKeySpec(RFC7748ParameterSpec spec, byte[] h) {
    ...
    public RFC7748PrivateKeySpec(byte[] seed, byte[] h, byte[] a, GroupElement A, RFC7748ParameterSpec spec) {
        this.seed = seed;
        this.h = h;
        this.a = a;
        this.A = A;
