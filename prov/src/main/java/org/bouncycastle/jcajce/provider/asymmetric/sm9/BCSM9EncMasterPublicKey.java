 ...
 * Combine it with a recipient identity to form a {@link BCSM9EncPublicKey}, the recipient
 * key supplied to {@code KeyGenerator.SM9-KEM} when encapsulating a key to that identity.
 * <p>
    ...
    implements PublicKey
{
    ...
    public BCSM9EncMasterPublicKey(SM9EncMasterPublicKeyParameters keyParams)
    {
        this.keyParams = keyParams;
    }

    public SM9EncMasterPublicKeyParameters getKeyParameters()
    {
        return keyParams;
    }
