 ...
 *
 */
public class RFC7748PrivateKey implements RFC7748Key, PrivateKey {
    ...
    public RFC7748PrivateKey(RFC7748PrivateKeySpec spec) {
    ...
    public RFC7748PrivateKey(PKCS8EncodedKeySpec spec) throws InvalidKeySpecException {
        this(new RFC7748PrivateKeySpec(decode(spec.getEncoded()),
                                    RFC7748NamedCurveTable.getByName("Ed25519")));
    }

    public RFC7748PrivateKey(PrivateKeyInfo keyInfo, String curveName) throws InvalidKeySpecException, IOException {
        this(new RFC7748PrivateKeySpec(decode(keyInfo.getEncoded()),
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof RFC7748PrivateKey))
            return false;
        RFC7748PrivateKey pk = (RFC7748PrivateKey) o;
