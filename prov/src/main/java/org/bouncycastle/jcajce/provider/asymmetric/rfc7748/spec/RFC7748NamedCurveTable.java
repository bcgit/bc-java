...
import org.bouncycastle.jcajce.provider.asymmetric.rfc7748.Utils;
import org.bouncycastle.jcajce.provider.asymmetric.rfc7748.math.Curve;
import org.bouncycastle.jcajce.provider.asymmetric.rfc7748.math.Field;
import org.bouncycastle.jcajce.provider.asymmetric.rfc7748.math.ed25519.Ed25519LittleEndianEncoding;
import org.bouncycastle.jcajce.provider.asymmetric.rfc7748.math.ed25519.Ed25519ScalarOps;

/**
 * The named RFC7748 curves.
 * @author str4d
 *
 */
public class RFC7748NamedCurveTable {
    ...
    private static final RFC7748NamedCurveSpec ed25519 = new RFC7748NamedCurveSpec(
            "Ed25519",
            ed25519curve,
            "SHA-512", // H
    ...
    private static final Hashtable<String, RFC7748NamedCurveSpec> curves = new Hashtable<String, RFC7748NamedCurveSpec>();

    public static void defineCurve(RFC7748NamedCurveSpec curve) {
        curves.put(curve.getName().toLowerCase(Locale.ENGLISH), curve);
    }

    static void defineCurveAlias(String name, String alias) {
        RFC7748NamedCurveSpec curve = curves.get(name.toLowerCase(Locale.ENGLISH));
        if (curve == null) {
    ...
    public static RFC7748NamedCurveSpec getByName(String name) {
