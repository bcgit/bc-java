...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyFactory." + EdDSAKey.KEY_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.eddsa.KeyFactory");
        put("KeyPairGenerator." + EdDSAKey.KEY_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.eddsa.KeyPairGenerator");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.eddsa.EdDSAEngine");
