...
/**
 * KeyFactory for the SM9 encryption master keys ({@code sm9encrypt}): the master public and
 * private keys round-trip through their JCA X.509 / PKCS#8 encodings (the GM/T 0080-2020 key
 * material under the GM algorithm OID; the bare GM/T 0080-2020 form is the lightweight
 * key-parameter class's {@code getEncoded()}).
 * <p>
 * A user's identity-based decryption key is <b>not</b> decodable in isolation - it additionally
 * needs the master public key and the identity - so derive it from the master private key via
 * {@code extractPrivateKey(id)} instead.
 */
    ...
    extends java.security.KeyFactorySpi
{
        ...
        throws InvalidKeySpecException
    {
        ...
        try
        {
            ...
            throw new InvalidKeySpecException("not an SM9 encryption master public key: " + oid);
        }
        ...
        throws InvalidKeySpecException
    {
        ...
        try
        {
            ...
            throw new InvalidKeySpecException("not an SM9 encryption master private key: " + oid);
        }
    ...
    {
        return key instanceof BCSM9EncMasterPublicKey
