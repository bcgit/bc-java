...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyFactory." + RFC7748Key.KEY_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.rfc7748.KeyFactorySpi");
        put("KeyPairGenerator." + RFC7748Key.KEY_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.rfc7748.KeyPairGeneratorSpi");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "org.bouncycastle.jcajce.provider.asymmetric.rfc7748.EdDSAEngine");
        ...
        put("Alg.Alias.KeyFactory.1.3.101.112", RFC7748Key.KEY_ALGORITHM);
        put("Alg.Alias.KeyFactory.OID.1.3.101.112", RFC7748Key.KEY_ALGORITHM);
        put("Alg.Alias.KeyPairGenerator.1.3.101.112", RFC7748Key.KEY_ALGORITHM);
        put("Alg.Alias.KeyPairGenerator.OID.1.3.101.112", RFC7748Key.KEY_ALGORITHM);
