...
/**
 * javax.crypto.KEM API tests for NTRU LPRime - {@code KEM.NTRULPRIME}, a family level service matching its SNTRU Prime sibling. The family had
 * Cipher, KeyGenerator and KeyPairGenerator services but no KEM one until now.
 */
public class NTRULPRimeKEM17Test
    extends TestCase
{
    private static final String KEM_NAME = "NTRULPRIME";
    private static final String KPG_NAME = "NTRULPRIME";
    ...
    /**
     * javax.crypto.KEM requires a Decapsulator to be safe for concurrent use. NTRULPRimeKEMExtractor holds no engine, so one is shared here.
     */
    ...
    private static final NTRULPRimeParameterSpec[] SPECS = new NTRULPRimeParameterSpec[]{
