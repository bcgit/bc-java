...
/**
 * javax.crypto.KEM API tests for SMAUG-T - {@code KEM.SMAUGT} plus one parameter-set locked service per set. The family had
 * Cipher, KeyGenerator and KeyPairGenerator services but no KEM one until now.
 */
public class SmaugTKEM17Test
    extends TestCase
{
    private static final String KEM_NAME = "SMAUGT";
    private static final String KPG_NAME = "SMAUGT";
    ...
    /**
     * javax.crypto.KEM requires a Decapsulator to be safe for concurrent use. SmaugTEngine carries no mutable state, so one extractor is shared here.
     */
    ...
    private static final SmaugTParameterSpec[] SPECS = new SmaugTParameterSpec[]{
    ...
    private static final String[] SPEC_NAMES = {"SMAUGT-MODE1", "SMAUGT-MODE3", "SMAUGT-MODE5", "SMAUGT-MODET"};

    private static final ASN1ObjectIdentifier[] OIDS = {
        org.bouncycastle.asn1.bc.BCObjectIdentifiers.smaugt_mode1,
        org.bouncycastle.asn1.bc.BCObjectIdentifiers.smaugt_mode3,
        org.bouncycastle.asn1.bc.BCObjectIdentifiers.smaugt_mode5,
        org.bouncycastle.asn1.bc.BCObjectIdentifiers.smaugt_modet
    };
}
