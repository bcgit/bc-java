...
/**
 * The PQC algorithm families that register parameter-set specific JCA services, shared by the
 * tests that sweep those services - {@link NamedKeyPairGeneratorTest} and
 * {@link NamedKeyFactoryTest}.
 * <p>
 * Every family lists all of its parameter sets, so a family added later has to be added here to
 * be swept. Where a parameter set name is not itself a registered algorithm alias the registered
 * names are given explicitly, index-matched to the specs. The stride is how often a check that
 * needs a generated key pair samples the list - 1 = every set - and is set per family from how
 * expensive that family's key generation is; the sampled sets are spread across security levels
 * and variants rather than clustered.
 * <p>
 * The pre-standardisation SPHINCS+ and Kyber provider classes, which neither provider had
 * registered since they were superseded by SLH-DSA and ML-KEM, were removed in 1.86.
 */
class PQCNamedParameterSets
{
    static class Family
    {
        ...
        Family(String genericName, String label, String provider, int stride, AlgorithmParameterSpec[] specs, String[] algNames)
        {
    ...
    static Family[] families()
    {
        return new Family[]
        {
            new Family("SLH-DSA", "SLH-DSA", "BC", 3,
            ...
            new Family("ML-KEM", "ML-KEM", "BC", 1,
                ...
                null),
            new Family("CMCE", "Classic McEliece", "BC", 4,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("FRODOKEM", "FrodoKEM", "BC", 1,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("QRUOV", "QRUOV", "BCPQC", 4,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("Faest", "FAEST", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("Haetae", "HAETAE", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("SDitH", "SDitH", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
            ...
            new Family("UOV", "UOV", "BCPQC", 3,
                ...
                null),
            new Family("SMAUGT", "SMAUG-T", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
            ...
            new Family("Falcon", "Falcon", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("NTRUPLUS", "NTRU+", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
...
null),
            ...
            new Family("Mayo", "MAYO", "BCPQC", 1,
                ...
                null),
            new Family("AIMer", "AIMer", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
            ...
            new Family("SQIsign", "SQIsign", "BCPQC", 1,
                new AlgorithmParameterSpec[]
                {
                ...
                null),
            new Family("Snova", "SNOVA", "BCPQC", 6,
                new AlgorithmParameterSpec[]
                {
    ...
    /**
     * The family-level KeyFactory a parameter set belongs to. SLH-DSA and ML-DSA each register two,
     * one for their pure parameter sets and a "HASH-" prefixed one for their pre-hash sets, which
     * are distinct algorithms and do not accept each other's keys; every other family has one.
     */
    static String genericNameFor(Family fam, String specName)
    {
        return specName.indexOf("-WITH-") >= 0 ? "HASH-" + fam.genericName : fam.genericName;
    }

    static String specName(AlgorithmParameterSpec spec)
        throws Exception
    {
    ...
    /**
     * The parameter set a key actually belongs to. Deliberately exhaustive rather than reflective:
     * a family added without a branch here fails loudly instead of being skipped.
     */
    static String paramSetName(Key key)
    {
