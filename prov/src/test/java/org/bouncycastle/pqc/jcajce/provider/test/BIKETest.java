...
/**
 * KEM tests for BIKE with the BCPQC provider.
 */
    ...
    extends TestCase
{
            ...
            throws Exception
    {
        ...
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("AES"));
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("AES-KWP"));

        kpg.initialize(BIKEParameterSpec.bike256, new SecureRandom());
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("AES"));
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("AES-KWP"));
    }
            ...
            throws Exception
    {
        ...
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("Camellia"));
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("Camellia-KWP"));
    }
            ...
            throws Exception
    {
        ...
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("SEED"));
    }
            ...
            throws Exception
    {
        ...
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("ARIA"));
        performKEMScipher(kpg.generateKeyPair(), "BIKE", new KEMParameterSpec("ARIA-KWP"));
    }
