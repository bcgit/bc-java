    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        XMSSMTPrivateKey nKey = (XMSSMTPrivateKey)xmssSig.getUpdatedPrivateKey();
        ...
        throws Exception
    {
        ...
        kpg.initialize(new XMSSMTParameterSpec(10, 2, XMSSMTParameterSpec.SHA256), new SecureRandom());
