 ...
 * </pre>
 *
 * @see com.github.gv2011.bcasn.asn1.x509.Certificate
 */
public class Certificate
{
    public static final Certificate EMPTY_CHAIN = new Certificate(
        new com.github.gv2011.bcasn.asn1.x509.Certificate[0]);

    protected com.github.gv2011.bcasn.asn1.x509.Certificate[] certificateList;

    public Certificate(com.github.gv2011.bcasn.asn1.x509.Certificate[] certificateList)
    {
    ...
    /**
     * @return an array of {@link com.github.gv2011.bcasn.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public com.github.gv2011.bcasn.asn1.x509.Certificate[] getCertificateList()
    {
        return cloneCertificateList();
    }

    public com.github.gv2011.bcasn.asn1.x509.Certificate getCertificateAt(int index)
    {
        ...
        throws IOException
    {
        ...
        while (buf.available() > 0)
        {
            ...
            certificate_list.addElement(com.github.gv2011.bcasn.asn1.x509.Certificate.getInstance(asn1Cert));
        }

        com.github.gv2011.bcasn.asn1.x509.Certificate[] certificateList = new com.github.gv2011.bcasn.asn1.x509.Certificate[certificate_list.size()];
        for (int i = 0; i < certificate_list.size(); i++)
        {
            certificateList[i] = (com.github.gv2011.bcasn.asn1.x509.Certificate)certificate_list.elementAt(i);
        }
        return new Certificate(certificateList);
    }

    protected com.github.gv2011.bcasn.asn1.x509.Certificate[] cloneCertificateList()
    {
        com.github.gv2011.bcasn.asn1.x509.Certificate[] result = new com.github.gv2011.bcasn.asn1.x509.Certificate[certificateList.length];
