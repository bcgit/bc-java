...
import com.github.gv2011.bcasn.crypto.BufferedBlockCipher;
    ...
    extends BufferedBlockCipher
{
     ...
     * @exception com.github.gv2011.bcasn.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception com.github.gv2011.bcasn.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception com.github.gv2011.bcasn.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
