...
public class PgpKey {
	...
	/**
	 * Gets the sub-keys.
	 * @return the sub-keys. Never <code>null</code>, if this is a master-key. Always <code>null</code>, if this is a sub-key.
	 * @see #getMasterKey()
	 * @see #getSubKeyIds()
	 */
	...
	public String toString() {
		...
		return String.format("%s[pgpKeyId=%s masterKey=%s primaryUserId=%s]", this.getClass().getSimpleName(), pgpKeyId, masterKey, primaryUserId);
	}
}
