...
public class TrustDbIo implements AutoCloseable, TrustConst
{
    ...
    public TrustDbIo(final File file) throws TrustDbIoException
    {
        ...
        try
        {
            this.raf = new RandomAccessFile(file, "rw"); // or better use rwd/rws? maybe manually calling sync is
                                                         // sufficient?!
    ...
    public synchronized <T extends TrustRecord> T getTrustRecord(final long recordNum, Class<T> expectedTrustRecordClass)
            throws TrustDbIoException
    {
