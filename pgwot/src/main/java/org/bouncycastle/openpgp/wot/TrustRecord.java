...
//			clone.nextCheck = (Date) nextCheck.clone();
//			return clone;
//		}
...
//		@Override
//		public HashTbl clone() {
//			HashTbl clone = (HashTbl) super.clone();
//			clone.item = new long[item.length];
//			System.arraycopy(item, 0, clone.item, 0, item.length);
//			return clone;
//		}
...
//		@Override
//		public HashLst clone() {
//			HashLst clone = (HashLst) super.clone();
//			clone.rnum = new long[rnum.length];
//			System.arraycopy(rnum, 0, clone.rnum, 0, rnum.length);
//			return clone;
//		}
...
//		@Override
//		public Trust clone() {
//			Trust clone = (Trust) super.clone();
//			clone.fingerprint = new byte[fingerprint.length];
//			System.arraycopy(fingerprint, 0, clone.fingerprint, 0, fingerprint.length);
//			return clone;
//		}

		@Override
		public String toString() {
			return String.format("%s[recordNum=%d fingerprint=%s ownerTrust=%d depth=%d validList=%d minOwnerTrust=%d]",
...
//		@Override
//		public Valid clone() {
//			Valid clone = (Valid) super.clone();
//			clone.nameHash = new byte[nameHash.length];
//			System.arraycopy(nameHash, 0, clone.nameHash, 0, nameHash.length);
//			return clone;
//		}
...
//	@Override
//	public TrustRecord clone() {
//		TrustRecord clone;
//		try {
//			clone = (TrustRecord) super.clone();
