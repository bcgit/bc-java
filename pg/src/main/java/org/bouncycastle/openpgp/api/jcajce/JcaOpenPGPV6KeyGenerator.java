        ...
        extends OpenPGPV6KeyGenerator
{
    ...
    public JcaOpenPGPV6KeyGenerator(Date creationTime, Provider provider)
            throws PGPException
    {
        this(DEFAULT_SIGNATURE_HASH_ALGORITHM, creationTime, provider, true);
    }

    public JcaOpenPGPV6KeyGenerator(int signatureHashAlgorithm, Provider provider)
            throws PGPException
    {
        this(signatureHashAlgorithm, new Date(), provider, true);
    }
     ...
     */
    public JcaOpenPGPV6KeyGenerator(int signatureHashAlgorithm, Date creationTime, Provider provider, boolean aeadProtection)
            throws PGPException
    {
        super(
