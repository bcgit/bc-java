    ...
    implements PBEProtectionRemoverFactory
{
        ...
        throws PGPException
    {
        ...
        {
            return new PGPSecretKeyDecryptorWithAAD(passPhrase, calculatorProvider, new JcaPGPS2KCalculator())
            {
        ...
        {
            return new PBESecretKeyDecryptor(passPhrase, calculatorProvider, new JcaPGPS2KCalculator())
            {
