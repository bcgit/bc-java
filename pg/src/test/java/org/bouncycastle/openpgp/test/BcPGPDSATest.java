    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        while (it.hasNext())
        {
            ...
            PGPUserAttributeSubpacketVector attr2 = PGPUserAttributeSubpacketVector.fromSubpackets(new UserAttributeSubpacket[]{attributes.getImageAttribute()});
            isTrue(attributes.getSubpacket(UserAttributeSubpacketTags.IMAGE_ATTRIBUTE).equals(
                attr2.getSubpacket(UserAttributeSubpacketTags.IMAGE_ATTRIBUTE)));
            isTrue(attributes.equals(attr2));
            isTrue(attributes.hashCode() == attr2.hashCode());
